              ...
              child: Column(
                ...
                children: [
                  ...
                  isLoading
                      ...
                      :
                    Expanded(child: QuizScreen(index: index,),),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                      ElevatedButton.icon(onPressed: prevQuiz, label: const Text("Prev"), icon:const Icon(Icons.arrow_back),),
                      ElevatedButton.icon(onPressed: nextQuiz, label: const Text("Next"), icon:const Icon(Icons.arrow_forward),)
                    ],)
                ],
              ),
            )
